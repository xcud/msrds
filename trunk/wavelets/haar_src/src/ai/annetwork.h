...
private:
        ...
        std::vector<AnnLayer::ACTFUN> m_actfuns;        
        std::vector<unsigned int> m_neurons;       //neurons per layer
        std::vector<AnnLayer *> m_layers;          //layers
...
{
        return m_actfuns[m_actfuns.size() - 1];
}
