...
void AnnLayer::run(enum ACTFUN fun, AnnLayer* pnext)
{
        const vec2D& tW = *m_tW;
...
void AnnLayer::set_input(const vec2D& x, enum ACTFUN fun)
{
...
void AnnLayer::get_output(float* ovec, enum ACTFUN fun) const
{
