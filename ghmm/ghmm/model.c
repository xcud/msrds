...
*
*
*       This file is version $Revision: 2022 $
*                       from $Date: 2007-12-20 00:24:11 +0900 (ык? 20 12 2007) $
...
#define CUR_PROC "ghmm_dmodel_generate_from_sequence"
  int i;
  //ghmm_dmodel **molist = NULL;
  ghmm_dmodel *mo = NULL;//malloc(sizeof( ghmm_dmodel));
  ghmm_dstate *s = NULL;
  ARRAY_CALLOC (mo, 1);
...
int ghmm_dmodel_xml_write2(ghmm_dmodel* mo, const char *file, int mo_number) {
#define CUR_PROC "ghmm_dmodel_xml_write"
